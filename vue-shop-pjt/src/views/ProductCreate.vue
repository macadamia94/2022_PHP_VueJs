  ...
  <main class="mt-3">
    <div class="container">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-md-9">
          <div class="input-group mb-3">
            <input type="number" min="0" class="form-control" ref="product_price" v-model="product.product_price">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-md-9">
          <div class="input-group mb-3">
            <input type="number" min="0" class="form-control" ref="delivery_price" v-model="product.delivery_price">
            <span class="input-group-text">원</span>
          </div>
        </div>
      </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-md-9">
          <div class="input-group mb-3">
            <input type="number" min="0" class="form-control" ref="outbound_days" v-model="product.outbound_days">
  ...
  methods: {
    ...
    productInsert() {
      ...
      this.$swal.fire({
        ...
        cancelButtonText: '취소'
      }).then(async result => { // .then　→　promise문
